...
FINANCIALS = [
    # ── Bajaj Finance ──────────────────────────────────────────────────────────
    ("Bajaj Finance", "FY2021", 147158, 174875, 38085, 14971, 4420, 3090, 2.1, 2.96, 2.53, 11.61, "audited", "Bajaj Finance AR FY21"),
    ...
    ("Bajaj Finance", "FY2024", 330615, 371080, 67034, 33401, 14451, 2975, 0.9, 1.06, 4.44, 24.28, "audited", "Bajaj Finance AR FY24"),
    ...
    ("Bajaj Housing Finance", "FY2021", 40300, 47200, 5900, 1650, 520, 40, 0.1, 0.25, 1.1, 8.81, "audited", "Bajaj Housing Finance AR FY21"),
    ...
    # ── LIC Housing Finance ───────────────────────────────────────────────────
    ("LIC Housing Finance", "FY2021", 214547, 240386, 20021, 5283, 2181, 1073, 0.5, 4.12, 0.91, 10.89, "audited", "LIC Housing Finance AR FY21"),
    ...
    # ── Shriram Finance ───────────────────────────────────────────────────────
    ("Shriram Finance", "FY2021", 112289, 145821, 24890, 10640, 4138, 2358, 2.1, 7.86, 2.84, 16.63, "audited", "Shriram Finance AR FY21"),
    ("Shriram Finance", "FY2022", 124985, 163021, 28100, 12178, 5000, 2250, 1.8, 7.00, 3.3, 19.0, "audited", "Shriram Finance AR FY22"),
    ("Shriram Finance", "FY2023", 168427, 209890, 44183, 14918, 6764, 2527, 1.5, 5.83, 3.63, 18.72, "audited", "Shriram Finance AR FY23"),
    ("Shriram Finance", "FY2024", 214972, 260571, 52234, 19010, 8747, 3010, 1.4, 5.36, 3.6, 18.1, "audited", "Shriram Finance AR FY24"),
    ("Shriram Finance", "FY2025", 248527, 302145, 63500, 22530, 9972, 3231, 1.3, 5.20, 3.54, 17.23, "audited", "Shriram Finance AR FY25"),
    # ── Muthoot Finance ───────────────────────────────────────────────────────
    ("Muthoot Finance", "FY2021", 51936, 61200, 14800, 5987, 3723, 52, 0.1, 1.9, 6.08, 25.16, "audited", "Muthoot Finance AR FY21"),
    ...
    ("Muthoot Finance", "FY2025", 105095, 122400, 31500, 12350, 6021, 105, 0.1, 1.9, 5.73, 21.35, "audited", "Muthoot Finance AR FY25"),
    # ── Cholamandalam ─────────────────────────────────────────────────────────
    ("Cholamandalam Investment and Finance", "FY2021", 69481, 84500, 11450, 5980, 1984, 1042, 1.5, 5.40, 2.35, 17.33, "audited", "Cholamandalam AR FY21"),
    ...
    ("Cholamandalam Investment and Finance", "FY2024", 150700, 183600, 21700, 12590, 5864, 1356, 0.9, 2.97, 3.68, 30.46, "audited", "Cholamandalam AR FY24"),
    ...
    # ── M&M Financial ─────────────────────────────────────────────────────────
    ("Mahindra & Mahindra Financial Services", "FY2021", 63491, 83000, 13500, 5130, 950, 2222, 3.5, 10.85, 1.14, 7.04, "audited", "M&M Financial Services AR FY21"),
    ...
    # ── IIFL Finance ──────────────────────────────────────────────────────────
    ("IIFL Finance", "FY2021", 38800, 50200, 8100, 2890, 1121, 388, 1.0, 2.20, 2.23, 13.84, "audited", "IIFL Finance AR FY21"),
    ...
    # ── Manappuram Finance ────────────────────────────────────────────────────
    ("Manappuram Finance", "FY2021", 26241, 32100, 7200, 3780, 1722, 52, 0.2, 2.03, 5.36, 23.92, "audited", "Manappuram Finance AR FY21"),
    ("Manappuram Finance", "FY2022", 26000, 32500, 8600, 4080, 1529, 52, 0.2, 2.30, 4.73, 19.35, "audited", "Manappuram Finance AR FY22"),
    ("Manappuram Finance", "FY2023", 29400, 36200, 10100, 4530, 1975, 44, 0.15, 2.10, 5.75, 21.12, "audited", "Manappuram Finance AR FY23"),
    ...
    ("CreditAccess Grameen", "FY2021", 12300, 14800, 2850, 1380, 443, 98, 0.8, 1.20, 2.99, 15.54, "audited", "CreditAccess Grameen AR FY21"),
    ("CreditAccess Grameen", "FY2022", 14720, 17500, 3350, 1730, 700, 221, 1.5, 6.80, 4.33, 22.58, "audited", "CreditAccess Grameen AR FY22"),
    ("CreditAccess Grameen", "FY2023", 19800, 23100, 4200, 2360, 1390, 119, 0.6, 1.08, 6.85, 36.82, "audited", "CreditAccess Grameen AR FY23"),
    ...
    # ── Spandana Sphoorty ─────────────────────────────────────────────────────
    ("Spandana Sphoorty", "FY2021", 7200, 9500, 2600, 950, 195, 72, 1.0, 0.78, 2.05, 7.5, "audited", "Spandana Sphoorty AR FY21"),
    ("Spandana Sphoorty", "FY2022", 7800, 10200, 2900, 1100, 386, 117, 1.5, 5.60, 4.0, 14.0, "audited", "Spandana Sphoorty AR FY22"),
    ("Spandana Sphoorty", "FY2023", 10900, 13400, 3500, 1580, 836, 87, 0.8, 1.90, 7.08, 26.12, "audited", "Spandana Sphoorty AR FY23"),
    ...
    ("Fusion Micro Finance", "FY2021", 5200, 6500, 1100, 780, 178, 47, 0.9, 1.28, 2.74, 16.18, "audited", "Fusion Micro Finance AR FY21"),
    ("Fusion Micro Finance", "FY2022", 6400, 8000, 1500, 1010, 310, 96, 1.5, 6.50, 4.28, 23.85, "audited", "Fusion Micro Finance AR FY22"),
    ("Fusion Micro Finance", "FY2023", 9200, 11200, 2300, 1520, 593, 74, 0.8, 2.30, 6.18, 31.21, "audited", "Fusion Micro Finance AR FY23"),
    ("Fusion Micro Finance", "FY2024", 11800, 14200, 3000, 2010, 798, 83, 0.7, 2.52, 6.1, 30.0, "audited", "Fusion Micro Finance AR FY24"),
    ("Fusion Micro Finance", "FY2025", 9500, 12100, 3000, 1890, -311, 760, 8.0, 9.06, -2.37, -10.37, "audited", "Fusion Micro Finance AR FY25"),
    # ── Five-Star Business Finance ────────────────────────────────────────────
    ("Five-Star Business Finance", "FY2021", 5200, 6100, 2000, 820, 315, 26, 0.5, 1.62, 5.16, 15.75, "audited", "Five Star Business Finance AR FY21"),
    ("Five-Star Business Finance", "FY2022", 6300, 7500, 3400, 1100, 505, 25, 0.4, 1.20, 7.43, 18.7, "audited", "Five Star Business Finance AR FY22"),
    ("Five-Star Business Finance", "FY2023", 8300, 9900, 4000, 1500, 714, 25, 0.3, 0.95, 8.21, 19.3, "audited", "Five Star Business Finance AR FY23"),
    ("Five-Star Business Finance", "FY2024", 10600, 12600, 4800, 1980, 1001, 32, 0.3, 0.87, 8.9, 22.75, "audited", "Five Star Business Finance AR FY24"),
    ("Five-Star Business Finance", "FY2025", 13000, 15600, 5900, 2520, 1266, 33, 0.25, 0.87, 8.98, 23.66, "audited", "Five Star Business Finance AR FY25"),
    # ── Home First Finance ────────────────────────────────────────────────────
    ("Home First Finance", "FY2021", 4680, 5500, 1100, 420, 150, 14, 0.3, 1.10, 2.73, 13.64, "audited", "Home First Finance AR FY21"),
    ("Home First Finance", "FY2022", 6000, 7100, 1400, 580, 226, 18, 0.3, 2.70, 3.59, 18.08, "audited", "Home First Finance AR FY22"),
    ("Home First Finance", "FY2023", 7900, 9300, 1800, 770, 375, 16, 0.2, 1.50, 4.57, 23.44, "audited", "Home First Finance AR FY23"),
    ("Home First Finance", "FY2024", 10200, 12000, 2400, 1000, 537, 18, 0.18, 1.60, 5.04, 25.57, "audited", "Home First Finance AR FY24"),
    ("Home First Finance", "FY2025", 13500, 15900, 3100, 1360, 711, 24, 0.18, 1.75, 5.1, 25.85, "audited", "Home First Finance AR FY25"),
    # ── Aavas Financiers ──────────────────────────────────────────────────────
    ("Aavas Financiers", "FY2021", 7800, 9300, 2100, 620, 280, 16, 0.2, 0.52, 3.01, 13.33, "audited", "Aavas Financiers AR FY21"),
    ("Aavas Financiers", "FY2022", 10200, 12000, 2500, 820, 416, 20, 0.2, 0.82, 3.8, 17.8, "audited", "Aavas Financiers AR FY22"),
    ("Aavas Financiers", "FY2023", 13100, 15400, 3000, 1100, 600, 26, 0.2, 0.97, 4.38, 21.82, "audited", "Aavas Financiers AR FY23"),
    ("Aavas Financiers", "FY2024", 16200, 19200, 3700, 1390, 769, 29, 0.18, 1.04, 4.45, 22.96, "audited", "Aavas Financiers AR FY24"),
    ("Aavas Financiers", "FY2025", 19600, 23300, 4600, 1730, 971, 29, 0.15, 1.07, 4.57, 23.4, "audited", "Aavas Financiers AR FY25"),
    # ── Aptus Value Housing Finance ───────────────────────────────────────────
    ("Aptus Value Housing Finance", "FY2021", 4300, 5100, 1700, 430, 215, 9, 0.2, 0.80, 4.22, 12.65, "audited", "Aptus Value Housing Finance AR FY21"),
    ...
    ("India Shelter Finance", "FY2021", 2200, 2700, 650, 230, 72, 11, 0.5, 1.80, 2.67, 11.08, "audited", "India Shelter Finance AR FY21"),
    ("India Shelter Finance", "FY2022", 3000, 3600, 1900, 310, 118, 15, 0.5, 2.80, 3.75, 9.25, "audited", "India Shelter Finance AR FY22"),
    ("India Shelter Finance", "FY2023", 4400, 5200, 2200, 460, 215, 18, 0.4, 1.50, 4.6, 10.5, "audited", "India Shelter Finance AR FY23"),
    ("India Shelter Finance", "FY2024", 6200, 7400, 2600, 680, 350, 19, 0.3, 1.24, 5.56, 14.58, "audited", "India Shelter Finance AR FY24"),
    ("India Shelter Finance", "FY2025", 8400, 10000, 3200, 940, 490, 24, 0.28, 1.20, 5.63, 16.9, "audited", "India Shelter Finance AR FY25"),
    # ── Satin Creditcare ──────────────────────────────────────────────────────
    ...
    ("Satin Creditcare Network", "FY2024", 12000, 14500, 2200, 1980, 610, 96, 0.8, 2.80, 4.75, 30.89, "audited", "Satin Creditcare AR FY24"),
    ("Satin Creditcare Network", "FY2025", 10200, 13000, 2400, 1850, 85, 663, 6.5, 8.20, 0.7, 3.7, "audited", "Satin Creditcare AR FY25"),
    # ── MAS Financial Services ────────────────────────────────────────────────
    ("MAS Financial Services", "FY2021", 4900, 6200, 1100, 520, 195, 39, 0.8, 1.80, 3.15, 17.73, "audited", "MAS Financial Services AR FY21"),
    ("MAS Financial Services", "FY2022", 6200, 7800, 1400, 680, 282, 43, 0.7, 2.10, 4.03, 22.56, "audited", "MAS Financial Services AR FY22"),
    ("MAS Financial Services", "FY2023", 8200, 10100, 1800, 910, 400, 49, 0.6, 1.92, 4.47, 25.0, "audited", "MAS Financial Services AR FY23"),
    ("MAS Financial Services", "FY2024", 10600, 13100, 2300, 1200, 544, 53, 0.5, 1.76, 4.5, 26.3, "audited", "MAS Financial Services AR FY24"),
    ("MAS Financial Services", "FY2025", 13200, 16500, 2900, 1520, 705, 66, 0.5, 1.73, 4.76, 27.12, "audited", "MAS Financial Services AR FY25"),
    # ── Repco Home Finance ────────────────────────────────────────────────────
    ("Repco Home Finance", "FY2021", 9800, 12600, 2200, 720, 238, 98, 1.0, 4.80, 1.89, 10.82, "audited", "Repco Home Finance AR FY21"),
    ...
    # ── SK Finance ────────────────────────────────────────────────────────────
    ("SK Finance", "FY2021", 3800, 4600, 900, 590, 120, 76, 2.0, 7.50, 2.61, 13.33, "audited", "SK Finance AR FY21"),
    ("SK Finance", "FY2022", 5100, 6200, 1100, 820, 232, 77, 1.5, 5.50, 4.1, 23.0, "audited", "SK Finance AR FY22"),
    ("SK Finance", "FY2023", 7400, 8900, 1700, 1250, 445, 59, 0.8, 2.50, 5.89, 31.79, "audited", "SK Finance AR FY23"),
    ("SK Finance", "FY2024", 10800, 13000, 2800, 1850, 619, 65, 0.6, 1.90, 5.65, 27.51, "audited", "SK Finance AR FY24"),
    ("SK Finance", "FY2025", 13600, 16600, 3500, 2400, 801, 82, 0.6, 1.89, 5.3, 25.6, "audited", "SK Finance AR FY25"),
    # ── Ugro Capital ──────────────────────────────────────────────────────────
    ("Ugro Capital", "FY2021", 1800, 2400, 1100, 180, -120, 54, 3.0, 3.50, -5.0, -10.91, "audited", "Ugro Capital AR FY21"),
    ("Ugro Capital", "FY2022", 3200, 4200, 1200, 310, 35, 80, 2.5, 4.20, 0.9, 3.0, "audited", "Ugro Capital AR FY22"),
    ("Ugro Capital", "FY2023", 5800, 7200, 1600, 620, 145, 87, 1.5, 2.80, 2.54, 10.36, "audited", "Ugro Capital AR FY23"),
    ("Ugro Capital", "FY2024", 8600, 10500, 2000, 1000, 281, 86, 1.0, 2.10, 3.18, 15.61, "audited", "Ugro Capital AR FY24"),
    ("Ugro Capital", "FY2025", 10800, 13200, 2400, 1320, 380, 108, 1.0, 2.20, 3.1, 17.1, "audited", "Ugro Capital AR FY25"),
    # ── Muthoot Microfin ──────────────────────────────────────────────────────
    ("Muthoot Microfin", "FY2022", 5500, 6800, 1200, 820, 215, 83, 1.5, 3.50, 3.16, 17.92, "audited", "Muthoot Microfin AR FY22"),
    ("Muthoot Microfin", "FY2023", 9200, 11000, 1600, 1380, 431, 74, 0.8, 1.50, 4.84, 30.79, "audited", "Muthoot Microfin AR FY23"),
    ("Muthoot Microfin", "FY2024", 13200, 15600, 2300, 1960, 652, 79, 0.6, 1.35, 4.9, 33.44, "audited", "Muthoot Microfin AR FY24"),
    ("Muthoot Microfin", "FY2025", 11200, 14000, 2500, 1900, 80, 784, 7.0, 6.80, 0.6, 3.3, "audited", "Muthoot Microfin AR FY25"),
    # ── SBI Cards and Payment Services ────────────────────────────────────────
    ("SBI Cards and Payment Services", "FY2021", 26027, 31261, 9213, 3804, 985, 1752, 6.7, 4.99, 3.15, 10.69, "audited", "SBI Cards AR FY21"),
    ("SBI Cards and Payment Services", "FY2022", 31190, 38009, 10085, 4474, 1616, 1621, 5.2, 2.22, 4.67, 16.75, "audited", "SBI Cards AR FY22"),
    ("SBI Cards and Payment Services", "FY2023", 40628, 49300, 11627, 5633, 2258, 1952, 4.8, 2.52, 5.0, 20.9, "audited", "SBI Cards AR FY23"),
    ("SBI Cards and Payment Services", "FY2024", 49299, 59424, 13212, 6392, 2407, 3064, 6.2, 3.06, 4.43, 19.38, "audited", "SBI Cards AR FY24"),
    ...
    ("Sammaan Capital", "FY2026-Q3", 64200, 76000, 22423, 2100, 957, 400, 0.83, 1.20, 2.30, 7.30, "audited", "Sammaan Capital Q3FY26 - 9M PAT ₹957 Cr; Growth AUM ₹44,038 Cr; net worth ₹22,423 Cr"),
    ...
    # ── KreditBee ─────────────────────────────────────────────────────────────
    ("KreditBee", "FY2023", 4800, 6000, 1500, 780, 280, 120, 2.5, 2.80, 4.67, 18.67, "estimated", "KreditBee MCA filings FY23 - estimated"),
    ("KreditBee", "FY2024", 7200, 9000, 2200, 1200, 420, 202, 2.8, 3.20, 5.6, 22.7, "estimated", "KreditBee MCA filings FY24 - estimated"),
    ...
    # ── Fibe ──────────────────────────────────────────────────────────────────
    ("Fibe", "FY2023", 3200, 4100, 900, 520, 145, 64, 2.0, 2.50, 3.54, 16.11, "estimated", "Fibe MCA filings FY23 - estimated"),
    ("Fibe", "FY2024", 5500, 7000, 1400, 890, 195, 165, 3.0, 3.80, 3.51, 16.96, "estimated", "Fibe MCA filings FY24 - estimated"),
